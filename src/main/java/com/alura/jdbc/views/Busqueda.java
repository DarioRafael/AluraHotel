...
//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"
	...
	public void cargarDatosReservas() {
		...
		try (Connection connection = connectionFactory.recuperaConexion();
			...
			while (resultSet.next()) {
				modelo.addRow(new Object[] { resultSet.getInt("numero de reserva"), resultSet.getDate("fecha check in"),
						resultSet.getDate("fecha check out"), resultSet.getString("valor"),
	...
	public void cargarDatosHuespedes() {
		...
		try (Connection connection = connectionFactory.recuperaConexion();
				PreparedStatement statement = connection.prepareStatement("SELECT * FROM huespedes");
				ResultSet resultSet = statement.executeQuery()) {

			while (resultSet.next()) {
				modeloHuesped.addRow(new Object[] { resultSet.getInt("Id"), resultSet.getString("Nombre"),
	...
	private void actualizarTablaHuespedes(List<Huespedes> huespedes) {
		modeloHuesped.setRowCount(0);
