...
public class ReservasView extends JFrame {
			...
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if ("date".equals(evt.getPropertyName())) {
					...
					if (fechaEntrada != null && fechaSalida != null) {
						...
						if("Tarjeta de Débito".equals(formaPagoSeleccionada)) {
							valorReserva = diferenciaEnDias > 0 ? diferenciaEnDias * 700 : 350;
						}
						
						if("Tarjeta de Crédito".equals(formaPagoSeleccionada)) {
							valorReserva = diferenciaEnDias > 0 ? diferenciaEnDias * 500 : 250;
						}
						
						if("Dinero en efectivo".equals(formaPagoSeleccionada)) {
							valorReserva = diferenciaEnDias > 0 ? diferenciaEnDias * 600 : 300;
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					RegistroHuesped registroHuesped = new RegistroHuesped(ReservasView.this);
	...
	public void guardarTabla() {
		...
		java.util.Date utilFechaSalida = txtFechaSalida.getDate();
		java.sql.Date fechaSalida = new java.sql.Date(utilFechaSalida.getTime());
		...
		Reservas reservas = reservasDao.insertarReserva(numeroReserva, fechaEntrada, fechaSalida, valor, formaDePago);
